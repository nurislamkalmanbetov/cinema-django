# Generated by Django 4.0.6 on 2022-07-19 08:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget', models.PositiveIntegerField(default=0, help_text='price in US$', verbose_name='Budget')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='price in US$', verbose_name='US fees')),
                ('fess_in_world', models.PositiveIntegerField(default=0, help_text='price in US$', verbose_name='Fees in the world')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='movies.reviews', verbose_name='Parents')),
            ],
            options={
                'verbose_name': 'Review',
